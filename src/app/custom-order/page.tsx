...
export const metadata: Metadata = {
  ...
  description:
    "Изготавливаем мебельные ножки, балясины, столбы для лестниц и другие изделия из дерева по индивидуальным размерам и требованиям заказчика.",
      ...
      <section className="border-b">
        <div className="mx-auto max-w-7xl px-4 py-12 sm:py-16">
          ...
          <p className="mt-5 max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">
            Изготавливаем мебельные ножки, балясины, столбы для лестниц и другие
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 lg:grid-cols-[0.8fr_1.2fr] lg:py-16">
          ...
          <div>
            ...
            <ul className="mt-6 space-y-4 text-muted-foreground">
              ...
              <li>Столбы и опорные элементы для лестниц</li>
              <li>Точёные деревянные детали</li>
